...
const EachCourse = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://coursify.onrender.com/users/courses/${id}`, {
        headers: {
  ...
  const descText =
    "This course is a crucial stepping stone towards achieving your goals. By delving deep into the subject matter, mastering essential skills, and gaining hands-on experience, you'll develop the expertise needed to excel in your chosen field. Additionally, the course offers valuable networking opportunities and access to industry professionals, enhancing your chances of securing relevant opportunities. Ultimately, completing this course will significantly bolster your knowledge, confidence, and overall competence, bringing you a significant step closer to realizing your aspirations.";
  return (
    <>
      <Appbar
        isLoggedIn={true}
      ...
      <div>
        <Card style={{ width: "80%", margin: "auto", marginTop: "3%" }}>
          <CardContent>
            ...
            >
              <Typography
                sx={{ fontFamily: "Poppins,sans-serif", marginTop: "2%" }}
                align="center"
                variant="h6"
              >
                {course.description}
            ...
            <Typography
              align="center"
              variant="h6"
              style={{ margin: "2%", textAlign: "center", marginTop: "5%" }}
            >
              {descText}
            </Typography>
