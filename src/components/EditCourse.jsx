...
function EditCourse() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://coursify.onrender.com/admin/courses/${id}`, {
        headers: {
  ...
  function handleClick(e) {
    ...
    axios
      .put(
        `https://coursify.onrender.com/admin/courses/${id}`,
        {
          title: title,
          description: desc,
          price: price,
        ...
        >
          ...
          >
            ...
            <TextField
              ...
              label="Image"
            ></TextField>
            <Typography style={{ marginTop: "3%" }} variant="standard">
              Published
            </Typography>
            <div>
